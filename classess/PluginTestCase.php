 ...
 * It makes use of the CreatesApplication trait instead of using a method to create the app.
 * This allows alternative databases to be used as opposed to the in memory database.
 *
 * @package Tests
 */
