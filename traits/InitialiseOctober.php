...
/**
 * Trait InitialiseOctober
 *
 * This trait contains the same set up and tear down methods as the PluginTestCase class file found in the /tests
 * folder of the default OctoberCMS installation. By moving this functionality to a trait it can be included within
 * any TestCase class files.
 *
...
trait InitialiseOctober
{
     ...
     * @return void
     */
    public function tearDownOctober()
    {
